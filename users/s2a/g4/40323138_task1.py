...
40323138_task1 = Blueprint('40323138_task1', __name__, url_prefix='/ag4', template_folder='templates')

# 40323138_task1 為完整可以單獨執行的繪圖程式
@40323138_task1.route('/40323138_task1')
def task1():
    outstring = '''
